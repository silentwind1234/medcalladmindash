(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('@angular/router'), require('rxjs/operators'), require('jsrsasign')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/common/http', '@angular/router', 'rxjs/operators', 'jsrsasign'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.angularAuthOidcClient = global.ng.angularAuthOidcClient || {}),global.ng.core,global.ng.common,global.ng.common.http,global.ng.router,global.Rx.Observable.prototype,global.jsrsasign));
}(this, (function (exports,_angular_core,_angular_common,_angular_common_http,_angular_router,rxjs_operators,jsrsasign) { 'use strict';
...
var OidcConfigService = /** @class */ (function () {
    function OidcConfigService() {
        this.onConfigurationLoaded = new _angular_core.EventEmitter();
    }
    /**
     * @param {?} configUrl
     * @return {?}
...
OidcConfigService.propDecorators = {
    "onConfigurationLoaded": [{ type: _angular_core.Output },],
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
...
var OidcSecurityUserService = /** @class */ (function () {
    ...
    OidcSecurityUserService.prototype.initUserData = function () {
        var _this = this;
        return this.getIdentityUserData().pipe(rxjs_operators.map(function (data) { return (_this.userData = data); }));
    };
    /**
     * @return {?}
     */
...
var OidcSecurityService = /** @class */ (function () {
    ...
    function OidcSecurityService(platformId, oidcDataService, stateValidationService, authConfiguration, router, oidcSecurityCheckSession, oidcSecuritySilentRenew, oidcSecurityUserService, oidcSecurityCommon, oidcSecurityValidation, tokenHelperService, loggerService, zone) {
        ...
        this.loggerService = loggerService;
        this.zone = zone;
        this.onModuleSetup = new _angular_core.EventEmitter();
        this.onAuthorizationResult = new _angular_core.EventEmitter();
        this.onCheckSessionChanged = new _angular_core.EventEmitter();
    ...
    OidcSecurityService.prototype.getSigningKeys = function () {
        if (this.authWellKnownEndpoints) {
            ...
            return this.oidcDataService
                ...
                .pipe(rxjs_operators.catchError(this.handleErrorGetSigningKeys));
        }
        else {
...
exports.ɵd = ArrayHelperService;
exports.ɵa = OidcDataService;
exports.ɵb = StateValidationService;
exports.ɵe = TokenHelperService;
exports.ɵf = LoggerService;
